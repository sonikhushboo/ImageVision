...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private static final int RC_SIGN_IN = 7283;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //object of the login layout
        tiemail = (TextInputEditText) findViewById(R.id.tiEditEmail);
        tiepass = (TextInputEditText) findViewById(R.id.tiEditInputPassword);
        tvtitle = (TextView) findViewById(R.id.tvlogin);
        ...
        btnlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (password.isEmpty()) {
                    tiepass.setError("password cannot be empty");
                    return;
                }
                if (password.length() < 8) {
                    tiepass.setError("password cannot be less than eight");
                    return;
                }

/*
                if (!password.equals(cpassword)){
                    tiepass.setError("password do not match");
                    return;
                }
*/
